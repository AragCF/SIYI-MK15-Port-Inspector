...
Java_com_mk15_sdk_Mk15NativeSerial_nativeOpen(
...
JNIEXPORT jint JNICALL
Java_com_mk15_sdk_Mk15NativeSerial_nativeRead(
...
JNIEXPORT jint JNICALL
Java_com_mk15_sdk_Mk15NativeSerial_nativeWrite(
...
Java_com_mk15_sdk_Mk15NativeSerial_nativeDescribe(
...
JNIEXPORT jint JNICALL
Java_com_mk15_sdk_Mk15NativeSerial_nativeClose(
        JNIEnv *env, jclass clazz, jint fd) {
    (void) env;
    (void) clazz;
    if (fd < 0) return 0;
